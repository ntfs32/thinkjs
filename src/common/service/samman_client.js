/**
 * Created by hushuang on 2016/11/20.
 */
 ...
 */
function generate(str, operation, key, expiry) {
...
function Samman_Client(apiUrl,apiKey,remoteUrl) {
    /**
     * API地址
     */
    this._apiUrl = apiUrl;
 ...
 */
Samman_Client.prototype.handler = function(request_type, args, service_url, method) {
    ...
    const params =
        ...
        + '&samman_request='
        + urlencode.encode(generate(requestJSON, this.encrypt, this._apiKey));
    if (method == 'POST') {
